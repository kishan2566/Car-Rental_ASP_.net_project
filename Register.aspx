<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="car_rental_project.Register" %>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    <div class="auth-container">
                        <div>
                            <center>
                            <h1 class="text-primary">Register</h1></center>
                        </div>
                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <asp:TextBox id="First_Name" class="form-control" placeholder="First name" runat="server" required></asp:TextBox>
                                            
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <label for="lastName" class="form-label">Last Name</label>
                                            <asp:TextBox id="Last_Name" class="form-control" placeholder="Last name" runat="server" required></asp:TextBox>
                                            
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label for="registerEmail" class="form-label">Email address</label>
                                        <asp:TextBox id="Email" class="form-control" placeholder="Enter your email" runat="server" required></asp:TextBox>
                                        
                                    </div>
                                    <div class="mb-4">
                                        <label for="registerPassword" class="form-label">Password</label>
                                        <asp:TextBox id="Password" class="form-control" placeholder="Create Password" runat="server" required></asp:TextBox>
