<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="old_cars.aspx.cs" Inherits="car_rental_project.old_cars" %>
    ...
    <div class="container py-5">
        ...
        <!-- Paging -->
          <div style="text-align: center; margin-top: 20px">
            <asp:LinkButton ID="LinkButton1" runat="server" Text="Previous" OnClick="LinkButton1_Click"  CssClass="btn btn-secondary rounded-pill px-4 mx-2" Enabled="false" />
            &nbsp;&nbsp;
            <asp:LinkButton ID="LinkButton3" runat="server" Text="Next" OnClick="LinkButton3_Click"  CssClass="btn btn-primary rounded-pill px-4 mx-2" />
        </div>

       <!-- Car Grid -->
<asp:DataList ID="DataList1" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" 
    CellPadding="10" CellSpacing="100" CssClass="w-100">
    <ItemTemplate>
        <div class="card h-100 shadow rounded">
            <img src='<%# Eval("Car_Image") %>' 
                 class="card-img-top" 
                 style="height:200px; object-fit:cover;" alt="Car" />

            <div class="card-body text-center">
                <h5 class="card-title mb-2">
                    <%# Eval("Car_Name") %>
                </h5>
                <h6 class="text-primary mb-3">$<%# Eval("Car_Price") %>/Day</h6>

                <div class="d-flex justify-content-between mb-3">
                    <small><i class="fa fa-users text-dark"></i> <%# Eval("Car_Seat") %> Seats</small>
                    <small><i class="fa fa-car text-dark"></i> <%# Eval("Car_Transmission") %></small>
                    <small><i class="fa fa-gas-pump text-dark"></i> <%# Eval("Car_Fuel") %></small>
                </div>
