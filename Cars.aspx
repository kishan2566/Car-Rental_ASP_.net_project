<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="Cars.aspx.cs" Inherits="car_rental_project.Cars" %>
       ...
       <head>
        ...
        <link href="css/style.css" rel="stylesheet">
           <style>
               .categories-img img {
    width: 100%;
    height: 250px; /* adjust as per design */
    object-fit: cover; /* crop image while keeping proportion */
...
<div class="container-fluid categories py-5">
    <div class="container py-5">
        <div class="text-center mx-auto pb-5" style="max-width: 800px;">
            ...
            <p class="mb-0">Choose from our wide selection of cars.</p>
        </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="categories-item p-4 shadow rounded">
                            <div class="categories-item-inner">
                                <div class="categories-img rounded-top mb-3">
                                    <img src='<%# Eval("Car_Image") %>' class="img-fluid w-100 rounded-top" alt="">
                                </div>
                                <div class="categories-content rounded-bottom">
                                    <h4 class="mb-3"><%# Eval("Car_Name") %></h4>
                                    <div class="mb-3">
                                        <h5 class="bg-white text-primary rounded-pill py-2 px-3 mb-0">
                                            $<%# Eval("Car_Price") %>/Day
                                        </h5>
                                    </div>
                                    <div class="row gy-2 gx-0 text-center mb-3">
                                        <div class="col-4 border-end">
                                            ...
                                            <span class="text-body ms-1"><%# Eval("Car_Seat") %> Seat</span>
                                        </div>
                                        <div class="col-4 border-end">
                                            <i class="fa fa-car text-dark"></i>
                                            <span class="text-body ms-1"><%# Eval("Car_Transmission") %></span>
                                        </div>
                                        <div class="col-4">
                                            <i class="fa fa-gas-pump text-dark"></i>
                                            <span class="text-body ms-1"><%# Eval("Car_Fuel") %></span>
                                        </div>
                                    </div>
                                  
                                    <asp:HyperLink ID="hlBook" runat="server" 
                                        NavigateUrl='<%# "BookCar.aspx?CarId=" + Eval("Id") %>'
                                        CssClass="btn btn-primary rounded-pill d-flex justify-content-center py-2"
                                        Text="Book Now" />
                                </div>
                            </div>
                        </div>
        ...
        <!-- Paging Buttons (place them AFTER the Repeater) -->
        <div class="text-center mt-4">
            <asp:LinkButton ID="lnkPrev" runat="server" CssClass="btn btn-secondary rounded-pill px-4 mx-2"
                OnClick="lnkPrev_Click">Previous</asp:LinkButton>

            <asp:LinkButton ID="lnkNext" runat="server" CssClass="btn btn-primary rounded-pill px-4 mx-2"
        ...
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href="About.aspx"><i class="fas fa-angle-right me-2"></i> About</a>
                    <a href="Cars.aspx"><i class="fas fa-angle-right me-2"></i> Cars</a>
                    <a href="service.aspx"><i class="fas fa-angle-right me-2"></i>Services</a>
                    <a href="team.aspx"><i class="fas fa-angle-right me-2"></i> Team</a>
                    <a href="Contact.aspx"><i class="fas fa-angle-right me-2"></i> Contact us</a>
                    <a href="Terms.aspx"><i class="fas fa-angle-right me-2"></i> Terms & Conditions</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href="#"><i class="fa fa-map-marker-alt me-2"></i> Rajkot, Gujarat, India</a>
                    <a href="mailto:info@example.com"><i class="fas fa-envelope me-2"></i> Cental@business.com</a>
     ...
     <div class="container">
         <div class="row g-4 align-items-center">
             ...
             <div class="col-md-6 text-center text-md-end text-body">
                 ...
                 Designed By <a class="border-bottom text-white" href="https://htmlcodex.com">Kishan,Karan,Bhautik</a>
             </div>
         </div>
     </div>
 </div>
