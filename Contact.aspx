<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="car_rental_project.Contact" %>
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="form-floating">
                                            <asp:TextBox ID="Name" class="form-control" placeholder="Your Name" runat="server"></asp:TextBox>
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="form-floating">
                                            <asp:TextBox ID="Project" class="form-control" placeholder="Project" runat="server"></asp:TextBox>
                                           
                                            <label for="project">Your Project (Optional)</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <asp:TextBox ID="Message" runat="server" style="height: 160px" class="form-control" placeholder="Leave a message here"></asp:TextBox>
                                            <label for="message">Message</label>
                                        </div>

                                    </div>
                                    <div class="col-12">
                                        <asp:Button ID="Button1" runat="server" class="btn btn-light w-100 py-3" Text="Send Message" OnClick="Button1_Click" />
                                    </div>
                                </div>
                            </form>
                        </div>
